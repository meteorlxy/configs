...
## [1.0.6](http://git.code.oa.com/javascript/rules/compare/@meteorlxy/eslint-config-prettier-typescript-react@1.0.5...@meteorlxy/eslint-config-prettier-typescript-react@1.0.6) (2020-12-16)

**Note:** Version bump only for package @meteorlxy/eslint-config-prettier-typescript-react

## [1.0.5](http://git.code.oa.com/javascript/rules/compare/@meteorlxy/eslint-config-prettier-typescript-react@1.0.4...@meteorlxy/eslint-config-prettier-typescript-react@1.0.5) (2020-08-22)
